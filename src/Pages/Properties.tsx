         ...
         <div className="bg-black/30">
             ...
             <div className="border-7 border-neutral-800/90 rounded-2xl bg-neutral-700/90 rounded-tr-none">
              ...
              <div className="flex-1 flex flex-col justify-center px-5 space-y-3 z-10 mb-6">
                  ...
                  <h1 className="text-white md:text-4xl text-3xl">Discover a World of Possibilities</h1>
        ...
        <section className="bg-black/30 p-5 pb-20">
          <div className="  ">
             <div className="flex-1 flex flex-col justify-center px-5 space-y-3 z-10 mb-6">
                  ...
                  <h1 className="text-white md:text-4xl text-3xl">Let's Make it Happen</h1>
            ...
            <form className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 border border-gray-700/40 rounded-3xl p-6 md:p-10">
              ...
              {/* Preferred Contact */}
              <div>
                <label className="text-gray-300 text-sm">Preferred Contact Method</label>
